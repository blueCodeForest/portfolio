    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('git_hub', models.URLField(blank=True, null=True, verbose_name='git_bubのURL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='portfolio.discription', verbose_name='説明文')),
            ],
            options={
